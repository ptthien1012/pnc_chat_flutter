...
part 'quick_reply_message.g.dart';

/// A class that represents text message.
@JsonSerializable()
@immutable
abstract class QuickReplyMessage extends Message {
  ...
  factory QuickReplyMessage.fromJson(Map<String, dynamic> json) =>
      _$QuickReplyMessageFromJson(json);

  /// Creates a full text message from a partial one.
  factory QuickReplyMessage.fromPartial({
    // required User author,
    int? senderType,
    String? id,
  ...
  @override
  Map<String, dynamic> toJson() => _$QuickReplyMessageToJson(this);
}

/// A utility class to enable better copyWith.
class _QuickReplyMessage extends QuickReplyMessage {
  _QuickReplyMessage({
    // required super.author,
    super.senderType,
    super.id,
