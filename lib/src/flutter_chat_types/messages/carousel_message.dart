...
import 'partial_text.dart';
 ...
 part 'carousel_message.g.dart';

/// A class that represents text message.
@JsonSerializable()
@immutable
abstract class CarouselMessage extends Message {
  ...
  factory CarouselMessage.fromJson(Map<String, dynamic> json) =>
      _$CarouselMessageFromJson(json);

  /// Creates a full text message from a partial one.
  factory CarouselMessage.fromPartial({
    // required User author,
    int? senderType,
    String? id,
  ...
  @override
  Map<String, dynamic> toJson() => _$CarouselMessageToJson(this);
}

/// A utility class to enable better copyWith.
class _CarouselMessage extends CarouselMessage {
   _CarouselMessage({
    // required super.author,
    super.senderType,
    super.id,
