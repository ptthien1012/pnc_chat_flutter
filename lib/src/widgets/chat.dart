...
class Chat extends StatefulWidget {
  ...
  final void Function(types.ContentButton contendButton) onPayload;
  ...
  final VoidCallback? onAttachmentPressed;
    ...
    /// See [Input.isMenuPressed].
final bool? isShowMenu;

    /// See [Input.onMenuPressed].
...
class ChatState extends State<Chat> {
  ...
  Widget _messageBuilder(
    ...
    // } else if (object is UnreadHeaderData) {
      ...
      if (message is types.SystemMessage) {
        ...
        final messageWidth =
            widget.showUserAvatars && !(message.isAuthor ?? true)
  ...
  void _onImagePressed(types.ImageMessage message) {
    final initialPage = _gallery.indexWhere(
      (element) => element.id == message.created_time
  ...
  void _refreshAutoScrollMapping() {
    ...
    for (final object in _chatMessages) {
      if (object is UnreadHeaderData) {
        ...
        _autoScrollIndexById[message.created_time!] = i;
      }
      i++;
    }
  }
