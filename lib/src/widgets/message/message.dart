...
import 'package:pnc_chat_flutter/src/flutter_chat_types/message.dart';
import 'package:pnc_chat_flutter/src/widgets/message/payload_message.dart';
...
//
  ...
  Widget build(BuildContext context) {
    // precacheImage(
        // const AssetImage('assets/chatbot.gif', package: 'pnc_chat_flutter'), context);
    final query = MediaQuery.of(context);
    final user = InheritedUser.of(context).user;
    final currentUserIsAuthor = message.isAuthor ?? false;
    final enlargeEmojis =
  ...
  // Widget _avatarBuilder() => Container(
        ...
        // decoration: BoxDecoration(
            // border: Border.all(color:  const Color(0xFFF99D29)),
      ...
      // ));
 Widget _avatarBuilder() => const SizedBox(
  width: 40,
              ...
              : Container(
                  decoration: BoxDecoration(
                    ...
                    color: !currentUserIsAuthor ||
                        ...
                        ? message.type != types.MessageType.carousel ? InheritedChatTheme.of(context).theme.secondaryColor : Colors.transparent
  ...
  Widget _messageBuilder() {
    switch (message.type) {
      ...
      case types.MessageType.quick_reply:
        final quickReplyMessage = message as types.QuickReplyMessage;
        return quickReplyMessageBuilder != null
            ? quickReplyMessageBuilder!(
                quickReplyMessage,
                messageWidth: messageWidth,
                showName: showName,
            ...
            : QuickReplyMessage(
                ...
                nameBuilder: nameBuilder,
                // onPreviewDataFetched: onPreviewDataFetched,
                // options: quickReplyMessageOptions,
                showName: showName,
                usePreviewData: usePreviewData,
                userAgent: userAgent,
              );
      case types.MessageType.payload:
        final payloadMessage = message as types.PayloadMessage;
        return PayloadMessage(message: payloadMessage, onPayload: onPayload);
      case types.MessageType.carousel:
        final carouselMessage = message as types.CarouselMessage;
